...
/**
 * Title: Header 004
 * Slug: charity-and-nonprofit/header-004
 * Categories: header
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url(get_stylesheet_directory_uri() . "/assets/images/header/header-4-img.png");?>","id":1628,"dimRatio":50,"focalPoint":{"x":0.5,"y":0.5},"style":{"spacing":{"padding":{"right":"0","left":"0","top":"var:preset|spacing|superbspacing-xxlarge","bottom":"var:preset|spacing|superbspacing-xxlarge"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-cover" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--superbspacing-xxlarge);padding-right:0;padding-bottom:var(--wp--preset--spacing--superbspacing-xxlarge);padding-left:0"><img class="wp-block-cover__image-background wp-image-1628" alt="" src="<?php echo esc_url(get_stylesheet_directory_uri() . "/assets/images/header/header-4-img.png");?>" style="object-position:50% 50%" data-object-fit="cover" data-object-position="50% 50%"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|superbspacing-small","left":"var:preset|spacing|superbspacing-small","top":"var:preset|spacing|superbspacing-small","bottom":"var:preset|spacing|superbspacing-small"}}},"layout":{"type":"constrained"}} -->
...
<h1 class="wp-block-heading has-text-align-center has-text-color has-superbfont-xxlarge-font-size" style="color:#fdfdfd;font-style:normal;font-weight:400">Associação Doe Amor E Gere Esperança</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"color":{"text":"#fdfdfd"}},"fontSize":"superbfont-medium"} -->
<p class="has-text-align-center has-text-color has-superbfont-medium-font-size" style="color:#fdfdfd">Uma iniciativa social de Astorga - PR dedicada a promover ações de solidariedade, fortalecer a comunidade e transformar vidas por meio do voluntariado. </p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="font-style:normal;font-weight:400;letter-spacing:1px">CONHEÇA NOSSO PROJETO</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
