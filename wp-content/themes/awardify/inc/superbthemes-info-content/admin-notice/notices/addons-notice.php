    ...
    <span class="st-sa-notification-wrapper">
        ...
        <span class="st-sa-notification-wrapper-paragraph"><?php echo esc_html(sprintf(/* translators: %s is the theme name */__("Install the %s companion plugin to unlock all theme features. This quick and free installation takes a few seconds and requires just one click.", 'awardify'), $theme_name)); ?>
            <span class="st-sa-notification-buttons-wrapper">
                <a href="<?php echo esc_url($nonce_url); ?>" class="st-sa-notification-buttons-purple spbtic-addons-install"><span class="dashicons dashicons-update hidden spbtic-addons-spinner"></span><span class="spbtic-addons-label"><?php echo esc_html__("Install & Activate", 'awardify'); ?></span></a>
            </span>
        </span>
        <style>
